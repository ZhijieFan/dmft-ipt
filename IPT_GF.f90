...
module IPT_GF
  ...
  interface allocate_gf
     module procedure allocate_keldysh_component
     module procedure allocate_keldysh_gf
  end interface allocate_gf

  interface deallocate_gf
     module procedure deallocate_keldysh_component
     module procedure deallocate_keldysh_gf
  ...
  interface assignment(=)
     module procedure keldysh_component_gf_identity
     module procedure keldysh_gf_identity
     module procedure keldysh_component_scalar_identity
     module procedure keldysh_gf_scalar_identity
  end interface assignment(=)
  public :: assignment(=)

  interface operator(+)
     module procedure add_keldysh_component
     module procedure add_keldysh_gf
