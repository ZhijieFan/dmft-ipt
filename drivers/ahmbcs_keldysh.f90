...
program hmipt
  ...
  do while (.not.converged)
     ...
     do i=1,L
        ...
        wf0(1,i)= conjg(fg(1,L+1-i))/det  + sigma(1,i)
        wf0(2,i)= fg(2,i)/det       + conjg(sigma(2,L+1-i))
     end do
     do i=1,L
     ...
     ! do i=-Lm,Lm 
     !    sk(1)%less%t(i) = U*calG11%less%t(i)
     !    sk(1)%gtr%t(i) =  U*calG11%gtr%t(i)
     !    !
     !    sk(2)%less%t(i) = U*calF12%less%t(i)
     !    sk(2)%gtr%t(i) =  U*calF12%gtr%t(i)
     !    !
